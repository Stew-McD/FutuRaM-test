...
info.cell(row=2, column=1).value = "This file contains the lists for the different matter classes. Please fill in the information for each matter in the corresponding sheet."
...
info.cell(row=12, column=1).value = "The templates for the matter datasheets are in a separate file in the templates folder"
